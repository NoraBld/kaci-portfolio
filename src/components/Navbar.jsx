  ...
  return (
    <nav className="navbar">
      ...
      <style>{`
        ...
        .logo { display: flex; align-items: center; gap: 0.4rem; }
        .logo h1 { font-size: 1.8rem; font-weight: 800; text-shadow: 0 0 10px white; }
        .logo-icon { font-size: 2rem; color: cyan; text-shadow: 0 0 12px cyan; animation: electric 1s infinite; }
        ...
        @keyframes electric {
          0%, 100% { color: cyan; text-shadow: 0 0 15px cyan; }
          25% { color: yellow; text-shadow: 0 0 25px yellow; }
          50% { color: cyan; text-shadow: 0 0 20px cyan; }
          75% { color: yellow; text-shadow: 0 0 25px yellow; }
        }
